...
from .value import Attachment, IntoValue, Sample, Value
...
class Queryable:
    ...
    def __init__(self, inner: _Queryable, receiver) -> None:
        self._inner_ = inner
